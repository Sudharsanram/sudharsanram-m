    ...
    <section id="about" className="about-section">
      <div className="about-container">
        ...
        <div className="about-wrapper">
          ...
          <span className='text1'>
            📊 Currently hold a <span className="col">CGPA</span> of <span className="col">8.03</span> (till 5th semester).
          </span>
          <span className='text1'>
            With hands-on experience in IoT development, I’ve created projects using<span className="col"> Arduino Uno, ESP32, and STM32,</span>  bringing intelligent systems to life. <span className="col">One of my recent projects is an Online Skill Assessment System.</span>
          </span>
          <span className='text1'>
