  ...
  return (
    <nav className="navbar">
      ...
      <div className={`menu ${menuOpen ? "active" : ""}`}>
        ...
        <a href="#portfolio" className="menulist" onClick={() => handleClick()}>Portfolio <img src={por} alt="" class="abt"/></a>
        <span className="menulist" onClick={() => handleClick(onResumeClick)}>Resume<img src={res} alt="" class="abt"/></span>
